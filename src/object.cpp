    ...
    switch (cmd_.type) {
        ...
        case command_t::pipe_peer_stats:
            process_pipe_peer_stats (cmd_.args.pipe_peer_stats.queue_count,
                                     ...
                                     cmd_.args.pipe_peer_stats.endpoint);
            break;
        ...
        case command_t::pipe_stats_publish:
            process_pipe_stats_publish (
              ...
              cmd_.args.pipe_stats_publish.outbound_endpoint,
              cmd_.args.pipe_stats_publish.inbound_endpoint);
            break;
                                          ...
                                          std::string *endpoint_)
{
    ...
    cmd.args.pipe_peer_stats.endpoint = endpoint_;
    send_command (cmd);
}
                                             ...
                                             std::string *inbound_endpoint_)
{
    ...
    cmd.args.pipe_stats_publish.outbound_endpoint = outbound_endpoint_;
    cmd.args.pipe_stats_publish.inbound_endpoint = inbound_endpoint_;
    send_command (cmd);
}
...
void zmq::object_t::process_pipe_peer_stats (uint64_t, own_t *, std::string *)
{
    zmq_assert (false);
}
